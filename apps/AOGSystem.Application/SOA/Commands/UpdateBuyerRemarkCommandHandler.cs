...
{
    public class UpdateBuyerRemarkCommandHandler : IRequestHandler<UpdateBuyerRemarkCommand, ReturnDto<RemarkQueryModel>>
    {
        private readonly IInvoiceListRepository _invoiceListRepository;
        public UpdateBuyerRemarkCommandHandler(IInvoiceListRepository invoiceListRepository)
        {
            _invoiceListRepository = invoiceListRepository;
        }

        public async Task<ReturnDto<RemarkQueryModel>> Handle(UpdateBuyerRemarkCommand request, CancellationToken cancellationToken)
        {
            ...
            model.UpdateBuyerRemark(request.Id, request.Message, DateTime.Now, request.UpdatedBy);
    ...
    public class UpdateBuyerRemarkCommand : IRequest<ReturnDto<RemarkQueryModel>>
    {
