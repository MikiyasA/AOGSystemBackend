...
{
    public class CloseAssignmentCommandHandler : IRequestHandler<CloseAssignmentCommand, ReturnDto<AssignmentQueryModel>>
    {
        private readonly IAssignmentRepository _assignmentRepository;
        private readonly IMediator _mediator;
        public CloseAssignmentCommandHandler(IAssignmentRepository assignmentRepository, IMediator mediator)
        {
            _assignmentRepository = assignmentRepository;
            _mediator = mediator;
        }

        public async Task<ReturnDto<AssignmentQueryModel>> Handle(CloseAssignmentCommand request, CancellationToken cancellationToken)
        {
            ...
            model.SetClosedBy(request.ClosedBy);
            model.SetClosedAt(DateTime.Now);
